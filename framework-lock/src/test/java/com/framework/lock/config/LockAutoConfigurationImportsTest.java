...
class LockAutoConfigurationImportsTest {

    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withConfiguration(AutoConfigurations.of(LockAutoConfiguration.class))
            .withBean(RedissonClient.class, LockAutoConfigurationImportsTest::redissonClient);

    @Test
    void autoConfigurationRegistersDistributedLockAspect() {
