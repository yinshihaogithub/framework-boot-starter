-- Framework Boot Starter MySQL initialization script.
-- Keep this aggregate script in sync with module-level scripts under src/main/resources/db/mysql/.
-- External platform schemas such as framework-job's xxl_job_admin.sql stay separate.

SET NAMES utf8mb4;
SET time_zone = '+08:00';

-- Source: framework-log/src/main/resources/db/mysql/sys_operation_log.sql
...
-- Source: framework-local-message/src/main/resources/db/mysql/framework_local_message.sql
...
-- Source: framework-mq/src/main/resources/db/mysql/framework_mq.sql
...
-- Source: admin-service/src/main/resources/db/mysql/admin_service.sql
